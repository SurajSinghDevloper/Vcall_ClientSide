...
import pic1 from '../assets/cirkit.jpg'
    ...
    <>
      <hr>
        <nav className="nav nav-pills nav-justified">
          <link className="nav-item nav-link active rounded-pill" to="/">className or Course</link>
          <link className="nav-item nav-link rounded-pill active" to="/">Offline className</link>
          <link className="nav-item nav-link rounded-pill active" to="/">Profile</link>
          <button className="nav-item nav-link danger active rounded-pill" to="/">Logout</button>
        </nav>
        {/* ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
        <Card classNameName="bg-dark text-bold mt-3">
          <Card.Img src={pic1} alt="Card image" classNameName='fluid' style={{ height: '20rem', Padding: "1rem" }} />
          <Card.ImgOverlay>
          ...
          <hr className="main-body">
            ...
            <hr className="row gutters-sm">
              ...
              <hr className="col-md-8">
                <hr className="card mb-3">
                  <hr className="card-body">
                    <div className="row">
                            ...
                            <hr>
                              <div className="row">
                                <div className="col-sm-12">
                                  <link className="btn btn-info " target="__blank" to={"https://www.bootdey.com/snippets/view/profile-edit-data-and-skills"}>Edit</link>
                                </div>
                              </div>
                            </hr>
                          </hr>
